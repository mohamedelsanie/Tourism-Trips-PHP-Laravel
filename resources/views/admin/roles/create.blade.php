<x-admin-layout>
                ...
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin/role.create.create') }}</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="clearfix mb-10">
                    <div class="pull-left">
                        <h4 class="text-blue h4">{{ __('admin/role.create.create') }}</h4>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.roles.store') }}" method="post" class="mt-6 space-y-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input name="name" placeholder="{{ __('admin/role.fields.title') }}" value="{{ old('name') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('name') border border-danger @enderror" type="text"/>
                    ...
                    <div class="col-sm-12 col-md-10">
                        <button class="btn btn-primary bg-gray-800" type="submit">{{ __('admin/role.fields.create') }}</button>
                    </div>
                </form>
    ...
    @section('page_title'){{ __('admin/role.create.title_tag') }}@endsection
</x-admin-layout>
