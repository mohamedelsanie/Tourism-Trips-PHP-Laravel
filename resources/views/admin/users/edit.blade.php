<x-admin-layout>
                ...
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin/user.edit.edit') }}<code>{{ $user->title }}</code></li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="clearfix mb-10">
                    <div class="pull-left">
                        <h4 class="text-blue h4">{{ __('admin/user.edit.edit') }} </h4>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-8 mb-30">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="name" placeholder="{{ __('admin/user.fields.name') }}" value="{{ $user->name }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('name') border border-danger @enderror" type="text"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="email" placeholder="{{ __('admin/user.fields.email') }}" value="{{ $user->email }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('email') border border-danger @enderror" type="email" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="edit_password" placeholder="************" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('password') border border-danger @enderror" type="password" />
                            ...
                            <div class="card card-box custom mb-10" id="accordionWork">
                                ...
                                <div id="collapseWork" class="card-body show" data-parent="#accordionWork" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <input name="dob" placeholder="{{ __('admin/user.fields.dob') }}" value="{{ $user->dob }}" class="border-gray-300 rounded-md shadow-sm date-picker2 form-control @error('dob') border border-danger @enderror" type="text"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <input name="phone_code" placeholder="{{ __('admin/user.fields.phone_code') }}" value="{{ $user->phone_code }}" class="border-gray-300 rounded-md shadow-sm form-control @error('phone_code') border border-danger @enderror" type="text"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <input name="phone" placeholder="{{ __('admin/user.fields.phone') }}" value="{{ $user->phone }}" class="border-gray-300 rounded-md shadow-sm form-control @error('phone') border border-danger @enderror" type="text"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <textarea name="quaote" class="border-gray-300 rounded-md shadow-sm textarea_editor form-control @error('quaote') border border-danger @enderror">{{ $user->quaote }}</textarea>
                                ...
                                <div id="collapseImage" class="card-body show pb-0" data-parent="#accordionImage" aria-expanded="true">
                                    <div class="form-group row" id="user_image_field_{{$field}}">
                                        <div class="col-sm-6 col-md-6 hidden">
                                            <input name="image" id="user_image_{{$field}}" placeholder="image" value="{{ $user->image }}" class="hidden form-control @error('image') border border-danger @enderror" type="text"/>
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <select name="status" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('status') border border-danger @enderror">
                                                @if($user->status == 'published')
                                                    <option value="published" selected>{{ __('admin/user.fields.published') }}</option>
                                                    <option value="disabled">{{ __('admin/user.fields.disabled') }}</option>
                                                @elseif($user->status == 'disabled')
                                                    <option value="published">{{ __('admin/user.fields.published') }}</option>
                                                    <option value="disabled" selected>{{ __('admin/user.fields.disabled') }}</option>
                                                @else
                                                    <option selected="">{{ __('admin/user.fields.choose') }}</option>
                                                    <option value="published">{{ __('admin/user.fields.published') }}</option>
                                                    <option value="disabled">{{ __('admin/user.fields.disabled') }}</option>
                                                @endif
                                            </select>
                        ...
                        <div class="col-sm-12 col-md-10">
                            <button class="btn btn-primary bg-gray-800" type="submit">{{ __('admin/user.fields.update') }}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    @endsection
    @section('page_title'){{  __('admin/user.edit.title_tag',['user' => $user->name]) }}@endsection
</x-admin-layout>
