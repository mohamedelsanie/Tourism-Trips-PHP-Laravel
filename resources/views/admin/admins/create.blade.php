                        ...
                        <div class="col-sm-12 col-md-4 mb-30">
                            ...
                            <div class="card card-box custom mb-10" id="accordionRole">
                                ...
                                <div id="collapseRole" class="card-body show" data-parent="#accordionRole" >
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="roles" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('roles') border border-danger @enderror">
                                                <option value="">{{ __('admin/admin.fields.choose') }}</option>
                                                @if($roles)
                                                    @foreach($roles as $role)
                                                        <option value="{{ $role }}" @if($role == old('role_id')) selected @endif>{{ $role }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
