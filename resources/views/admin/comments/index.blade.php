                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ __('admin/comment.index.title') }}
                            </li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-6 col-sm-12 text-right">
                    @if(AdminCan('postcomment-create'))
                    <a href="{{ route('admin.comments.create') }}" class="btn btn-primary btn-sm scroll-click"><i class="fa fa-plus"></i> {{ __('admin/comment.index.create') }}</a>
                    @endif
                    @if(AdminCan('postcomment-forcedelete'))
                    <a href="{{ route('admin.comments.archive') }}" class="btn btn-primary btn-sm scroll-click">{{ __('admin/comment.index.archive') }}</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="py-12">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="clearfix mb-10">
                            <div class="pull-left">
                                <h4 class="text-blue h4">{{ __('admin/comment.index.title') }}</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <form name="search_form" method="post" action="{{route('admin.comments.search')}}" >
                            @csrf
                ...
                <form name="destroy_all" method="post" action="{{route('admin.comments.destroy_all')}}" >
                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            @if(AdminCan('postcomment-edit'))
                                                <a href="{{ route('admin.comments.edit',$comment->id) }}" data-color="#265ed7" style="color: rgb(38, 94, 215);"><i class="icon-copy dw dw-edit2"></i></a>
                                            @endif
                                            @if(AdminCan('postcomment-delete'))
...
{{--                                                <a href="{{ route('admin.comments.delete',$comment->id) }}" data-color="#e95959" style="color: rgb(233, 89, 89);"><i class="icon-copy dw dw-delete-3"></i></a>--}}
                        ...
                        @else
                            <tr>
                                <td colspan="5">{{ __('admin/comment.index.notfound') }}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
    ...
    @section('page_title'){{ __('admin/comment.index.title_tag') }}@endsection
</x-admin-layout>
