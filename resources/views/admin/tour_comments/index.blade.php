        ...
        <div class="page-header mb-0">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    @if(AdminCan('tourcomment-create'))
                    <a href="{{ route('admin.tour.comments.create') }}" class="btn btn-primary btn-sm scroll-click"><i class="fa fa-plus"></i> {{ __('admin/tour_comment.index.create') }}</a>
                    @endif
                    @if(AdminCan('tourcomment-forcedelete'))
                    <a href="{{ route('admin.tour.comments.archive') }}" class="btn btn-primary btn-sm scroll-click">{{ __('admin/tour_comment.index.archive') }}</a>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="p-6 text-gray-900">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <form name="search_form" method="post" action="{{route('admin.tour.comments.search')}}" >
                            @csrf
                ...
                <form name="destroy_all" method="post" action="{{route('admin.tour.comments.destroy_all')}}" >
                    @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            @if(AdminCan('tourcomment-edit'))
                                                <a href="{{ route('admin.tour.comments.edit',$comment->id) }}" data-color="#265ed7" style="color: rgb(38, 94, 215);"><i class="icon-copy dw dw-edit2"></i></a>
                                            @endif
                                            @if(AdminCan('tourcomment-delete'))
