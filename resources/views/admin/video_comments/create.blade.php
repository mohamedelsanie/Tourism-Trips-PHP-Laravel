<x-admin-layout>
                ...
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin/video_comment.create.create') }}</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="clearfix mb-10">
                    <div class="pull-left">
                        <h4 class="text-blue h4">{{ __('admin/video_comment.create.create') }}</h4>
                    </div>
                </div>
                <div class="dropdown-divider"></div>

                <form action="{{ route('admin.video.comments.store') }}" method="post" class="mt-6 space-y-6">
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-8 mb-30">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/video_comment.fields.name') }}</label>
                                <div class="col-sm-12 col-md-12">
                                    <input name="name" placeholder="{{ __('admin/video_comment.fields.name') }}" value="{{ old('name') }}" class="border-gray-300 rounded-md shadow-sm form-control @error('name') border border-danger @enderror" type="text"/>
                            ...
                            <div class="card card-box custom mb-10" id="accordionWork">
                                ...
                                <div id="collapseWork" class="card-body show" data-parent="#accordionWork" >
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/video_comment.fields.comment') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/video_comment.fields.video_id') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <select name="video_id" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('video_id') border border-danger @enderror">
                                                <option value="" @if(old('video_id') == '') selected @endif>{{ __('admin/video_comment.fields.choose') }}</option>
                                                @foreach($posts as $post)
                                                    <option value="{{ $post->id }}" @if(old('video_id') == $post->id) selected @endif>{{ $post->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/video_comment.fields.user_id') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <select name="user_id" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('user_id') border border-danger @enderror">
                                                <option value="" @if(old('user_id') == '') selected @endif>{{ __('admin/video_comment.fields.choose') }}</option>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/video_comment.fields.comment_stars') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <select name="comment_stars" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('comment_stars') border border-danger @enderror">
                                                <option value="" @if(old('comment_stars') == '') selected @endif>{{ __('admin/video_comment.fields.choose') }}</option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12">
                                            <select name="status" class="border-gray-300 rounded-md shadow-sm custom-select col-12 @error('status') border border-danger @enderror">
                                                <option value="" @if(old('status') == '') selected @endif>{{ __('admin/video_comment.fields.choose') }}</option>
                                                <option value="publish" @if(old('status') == 'publish') selected @endif>{{ __('admin/video_comment.fields.publish') }}</option>
                                                <option value="pending" @if(old('status') == 'pending') selected @endif>{{ __('admin/video_comment.fields.pending') }}</option>
                                                <option value="draft" @if(old('status') == 'draft') selected @endif>{{ __('admin/video_comment.fields.draft') }}</option>
                                            </select>
                        ...
                        <div class="col-sm-12 col-md-10">
                            <button class="btn btn-primary bg-gray-800" type="submit">{{ __('admin/video_comment.fields.create') }}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    @section('page_title'){{ __('admin/video_comment.create.title_tag') }}@endsection
</x-admin-layout>
