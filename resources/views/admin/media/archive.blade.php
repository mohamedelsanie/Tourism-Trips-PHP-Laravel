<x-admin-layout>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="clearfix mb-10">
                            <div class="pull-left">
                                <h4 class="text-blue h4">{{ __('admin/media.archive.title') }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <form name="restore_all" method="post" action="{{route('admin.media.restore_all')}}" >
                    @csrf
                    <table class="table table nowrap table-bordered table-striped no-footer dtr-inline">
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            @if(AdminCan('media-forcedelete'))
                                                ...
                                                <a href="{{ route('admin.media.restore',$med->id) }}" data-color="#265ed7"><i class="icon-copy dw dw-cursor-1"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
                        ...
                        @else
                            <tr>
                                <td colspan="4">{{ __('admin/media.archive.notfound') }}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
    ...
    @section('page_title'){{ __('admin/media.archive.title_tag') }}@endsection
</x-admin-layout>
