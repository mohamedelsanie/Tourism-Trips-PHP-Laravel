                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('videos') }}">{{ __('front/post_types.videos.title') }} </a></li>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="blog-details-text">
                        ...
                        <div class="owl-carousel owl-theme">
                            @foreach($post->gallery['link'] as $gal)
                                <div class="item-video" data-merge="1"><a class="owl-video" href="{{ $gal }}"></a></div>
                            @endforeach
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="post-author-area d-flex align-items-center justify-content-between mb-50">
                        ...
                        <div class="author-social-info d-flex align-items-center">
                            ...
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ getVideoLink($post->slug) }}" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a href="https://twitter.com/intent/tweet?url={{ getVideoLink($post->slug) }}&text={{ $post->title }}" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a href="https://plus.google.com/share?url={{ getVideoLink($post->slug) }}" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                    ...
                    @if(getSetting('comments_mode') == 'open')
                        @if($post->comments_status == 'open')
                            ...
                            <div class="roberto-contact-form mt-80 mb-100" id="addComment">
                                ...
                                <form action="{{ route('videos.add_comment',$post->slug) }}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            @auth()
                                        ...
                                        <input name="video_id" type="text" class="hidden" value="{{ $post->id }}" />
                                        <div class="col-12">
...
//                    dots: true,
    ...
    @section('page_title'){{ __('front/post_types.videos.title') }} - {{ $post->title }}@endsection
</x-app-layout>